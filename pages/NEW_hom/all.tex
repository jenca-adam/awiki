...
\begin{proof} The inequality in (i) is easily  checked, since $(f\otimes g)(st)$ can be 1 only if
...
To prove (ii), notice that for $s\in \{0,1\}^n$ and $t\in \{0,1\}^m$, 
\[
f(s)(g(t)\vee h(t))=
f(s)(g(t)+h(t)-g(t)h(t))=f(s)g(t)+f(s)h(t)-f(s)^2g(t)h(t)=f(s)g(t)\vee f(t)h(t),
\]
note that $f(t)^2=f(t)$. The statement for $\wedge$ is clear from $(g\wedge h)(t)=g(t)h(t)$.
