...
%
%\subsubsection{The second proof when $z>1/2$}\label{Sec-6.1.2}
%
...
%
%\bigskip\noindent
%{\bf The second proof of Theorem \ref{T-6.1} when $z\ge1$.}\enspace
...
%shown. Moreover, (1) immediately implies (2) as in the last part of the first proof of Theorem \ref{T-6.1}.
%{\color{red}[I don't see how to modify Remark 2 in your notes (Jan.\ 10, 2024) in the case $\alpha<1$. On
%the other hand, (2) is immediate from (1) in this case, as in the last part of the first proof of Th.~\ref{T-6.1}.]}
...
%
%\noindent
%{\bf The second proof of Theorem \ref{T-6.1} when $1/2<z<1$.}\enspace
...
%by Lemma \ref{L-6.5} and \eqref{F-C.6}. Since $L^p_\eta=C_\theta(L^p_{\eta_1},L^p_{\eta_2})$ by the
