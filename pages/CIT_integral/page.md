...
Here we would like to prove that the cone of convex functions on $\mathbb R_+$ is generated by functions of the form 
$(1-sx)\_-$ (- the negative parts) and constants. (Or something like this).

- relation of convex functions on $\mathbb R^+$ ($P(\mathbb R_+)$) to convex functions on $(0,1)$  ($P((0,1))$) (e.g. [hiai2021quantum](hiai2021quantum), Appendix C (op. convex to op. convex)    
- integral reps. of elements in $P((0,1))$?
