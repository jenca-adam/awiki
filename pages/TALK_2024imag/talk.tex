...
of Sciences\\[2mm]
\includegraphics[width=1.3cm]{logomu.pdf}\hspace*{4.75cm}~%
  \includegraphics[width=1.4cm]{logosav}\\[6mm]

{\normalsize Joint work with Fumio Hiai}\\[6mm]}


\date{ Granada, May 9, 2024}
...
\]
where $0<\alpha\ne 1$ and $z>0$.\myfootnote{Jaksi\'c, Ogata, Pautrat and  Pillett, 2011}
